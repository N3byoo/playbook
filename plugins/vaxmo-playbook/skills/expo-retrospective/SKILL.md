---
name: expo-retrospective
description: Use after completing a development cycle to capture learnings, update the backlog, and report to the user. Triggers after deploy completes or when asked to do a retrospective.
version: 1.0.0
---
